...
def load_mobility_data(country):
    cwd = Path.cwd()
    mobility_data_path = cwd.parent / Path("data/mobility-data/mobility-data.csv")
...
def load_variant_prevalence_data(country):
    cwd = Path.cwd()
    variant_data_path = cwd.parent / Path("data/variant-data/variant-prevalence.csv")
...
def load_vaccination_data(country):
    cwd = Path.cwd()
    vaccination_data_path = cwd.parent / Path("data/vaccination-data/vaccination-data.csv")
